            ...
            <form class="space-y-4 md:space-y-6" action="signup.php" method="post" id="signup-form">
                 ...
                 <div class="flex-1">
                  ...
                  <div>
                      ...
                      <input type="email" name="email" id="email1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com">
                ...
                <div class="hidden-fields hidden">
                    ...
                    <input type="number" name="experience" id="experience" min="1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="10">
                    <div class="error text-sm text-red-600"></div>
                </div>
                <div class="hidden-fields hidden">
